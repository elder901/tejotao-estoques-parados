...
import { Save, Package, TrendingDown, Calendar, DollarSign, BarChart3, User, Target } from 'lucide-react';
            ...
            <div className="space-y-3">
              ...
              <div>
                ...
                <Textarea
                  ...
                  placeholder="Detalhes da ação, negociações, contatos..."
...
function MetricCard({ label, value, accent, danger, warning }: { label: string; value: string; accent?: boolean; danger?: boolean; warning?: boolean }) {
  return (
    <div className="bg-card border rounded-md p-2 text-center">
      ...
      <div className={`text-sm font-bold ${danger ? 'text-destructive' : warning ? 'text-accent' : accent ? 'text-primary' : 'text-foreground'}`}>
        {value}
      </div>
    </div>
  );
